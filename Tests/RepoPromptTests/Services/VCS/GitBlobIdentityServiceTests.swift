...
final class GitBlobIdentityServiceTests: XCTestCase {
    ...
    func testNestedRepositoryMarkersBlockOuterBlobIdentityWhileNestedRootRemainsEligible() async throws {
        ...
        _ = try fixture.runGit(["config", "core.autocrlf", "false"], at: nested)
        _ = try fixture.runGit(["config", "core.eol", "native"], at: nested)
        try fixture.configureHermeticAttributesFile(at: nested)
